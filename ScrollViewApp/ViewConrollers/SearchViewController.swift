...
class SearchViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    let recentlyWatchedData = [
                               Item(title: "IPhone 15 Pro", subtitle: "Смартфон Apple IPhone 15 Pro 128GB", price: "2499 BYN", images: [UIImage(named: "iphone1")!, UIImage(named: "iphone2")!, UIImage(named: "iphone3")!], colors: [UIColor.gray, UIColor.white, UIColor.darkGray], isCompatible: true),
                               Item(title: "IPad Air M1", subtitle: "Планшет IPad Air 5TH GEN M1 Chip 256 GB", price: "2799 BYN", images: [UIImage(named: "ipad1")!, UIImage(named: "ipad2")!], colors: [UIColor.darkGray, UIColor.cyan, UIColor.magenta], isCompatible: true),
                               Item(title: "IPhone 13 Silicon Case", subtitle: "Чехол для IPhone 13 Silicon Case", price: "59 BYN", images: [UIImage(named: "chehol")!], colors: [UIColor.white], isCompatible: true),
                               Item(title: "MacBook Air M1", subtitle: "Ноутбук MacBook Air M1 8GB/256GB 2020", price: "2999 BYN", images: [UIImage(named: "mac")!], colors: [UIColor.gray, UIColor.white], isCompatible: true),
                               Item(title: "AirPods Pro 2", subtitle: "Наушники AirPods Pro 2", price: "899 BYN", images: [UIImage(named: "pods1")!, UIImage(named: "pods2")!, UIImage(named: "pods3")!], colors: [UIColor.white], isCompatible: true),
    ]
